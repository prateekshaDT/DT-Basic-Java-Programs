app.controller("AllBlogsController",function($scope,$http,$rootScope,$route)	
					...
					console.log("username in allblog controller:"+$rootScope.uname);
							 $http.get("http://localhost:8084/BackEndCollboratin2/viewAllBlogs")
							 ...
							 { 
						       ...
						       var like=
								...
								console.log("postedby:"+$rootScope.uname);
								 $http.put('http://localhost:8084/BackEndCollboratin2/updateBlog',like);
								 $http.get("http://localhost:8084/BackEndCollboratin2/viewBlogs")
								    .then(function (response) {
					 ...
					 $http.get("http://localhost:8084/BackEndCollboratin2/viewComments/"+$scope.viewcomments.blog_id)
								    .then(function (response) {
						...
						$scope.comment=function(allblogs)
						{
							...
							$http.post('http://localhost:8084/BackEndCollboratin2/addComment',comment);
							 $http.get("http://localhost:8084/BackEndCollboratin2/viewBlogs")
							    .then(function (response) {
