	...
	<div id="all">
					...
					<div class="col-md-5">
						<ul class="breadcrumb">
							...
							<li><a href="<c:url value="/usercart/cart/refreshCart/${cartId}"/>"
										...
										<li>
										<li><a href="<spring:url value="/" />" class="btn btn-primary" >CONTINUE SHOPPING</a><li>
								<li><a href="<spring:url value="/checkout"/>" class="btn btn-primary
								"> CHECK OUT </a><li> 
		...
		<div data-role="footer" style="text-align: center;">
			...
			<a href="<spring:url value="/shippingdetails"/>"
				class="btn btn-primary"class="ui-btn ui-corner-all ui-shadow ui-btn-icon-left">BUY NOW</a><br>
		<br>	<a href="<c:url value="/index"/>"
				class="btn btn-primary"class="ui-btn ui-corner-all ui-shadow ui-icon-plus ui-btn-icon-left">ADD
				MORE PRODUCTS</a><br><br>
